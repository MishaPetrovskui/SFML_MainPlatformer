    ...
    map<string, vector<IntRect>> animation = {
        ...
        },
        {
            "walkToRight", {
                ...
                IntRect({18, 46}, {54, 50}),
                IntRect({146, 46}, {54, 50}),
                IntRect({274, 46}, {54, 50}),
                IntRect({402, 46}, {54, 50}),
                IntRect({530, 46}, {54, 50}),
                IntRect({658, 46}, {54, 50}),
                IntRect({786, 46}, {54, 50}),
                IntRect({914, 46}, {54, 50}),
                IntRect({1042, 46}, {54, 50}),
                IntRect({1170, 46}, {54, 50}),
                IntRect({1298, 46}, {54, 50}),
                IntRect({1426, 46}, {54, 50}),
                IntRect({1556, 46}, {54, 50}),
                IntRect({1682, 46}, {54, 50}),
                IntRect({1810, 46}, {54, 50}),
            }
        },
        {
            "walkToLeft", {
